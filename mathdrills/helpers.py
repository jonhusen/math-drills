...
class Score:
    ...
    def __init__(self):
        ...
        self.exercise_correct = 0
        self.exercise_incorrect = 0

    def add_correct(self):
        self.total_correct += 1
        self.exercise_correct += 1

    def add_incorrect(self):
        self.total_incorrect += 1
        self.exercise_incorrect += 1

    def exercise_reset(self):
        self.exercise_correct = 0
        self.exercise_incorrect = 0

    def exercise_total(self):
        return self.exercise_correct + self.exercise_incorrect
